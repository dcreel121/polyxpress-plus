 ...
 * @license MIT
 * @desc I just wrapped the MarkerWithLabel documented in the comment below in a module.
 */
...
// End Module Header
    ...
    container.exports = function () {
         ...
         */
        markerWithLabel.MarkerWithLabel = function MarkerWithLabel(opt_options) {
        ...
        inherits(markerWithLabel.MarkerWithLabel, google.maps.Marker);
         ...
         * @private
         */
        markerWithLabel.MarkerWithLabel.prototype.setMap = function(theMap) {
